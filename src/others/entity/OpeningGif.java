...
import others.infra.Game.GameState;
...
import static others.infra.Game.GameState.TITLE;
 ...
 * @author ABIR
 */
public class OpeningGif extends Entity {
    ...
    public void start() {
        try {
            ...
            Logger.getLogger(OpeningGif.class.getName()).log(Level.SEVERE, null, ex);
            System.exit(-1);
        }
    ...
    protected void fixedUpdateOLPresents() {
        switch (ip) {
            case 0:
                distortionOffset += 1 * Time.getFixedDeltaTime();
