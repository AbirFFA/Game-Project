package others.infra;

import others.entity.BrickPushing;
import others.entity.FadeEffect;
import others.entity.Flag;
import others.entity.HUD;
import others.entity.Initializer;
import others.entity.Mario;
import others.entity.OpeningGif;
import others.entity.Point;
import others.entity.Screen;
import others.entity.Tilemap;
import others.entity.Title;
...
public class Game {
    ...
    private void createAllEntities() {
        ...
        addEntityLocal(new OpeningGif(this));
